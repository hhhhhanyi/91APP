const search = () => {
  ...
  fetch('/data', {
    ...
    if (!data.error) {
      ...
      document.getElementsByClassName("subtitle")[0].innerHTML = `${year}-${month} 中 24 個小時的平均車費、平均小費、小費／車費百分比、車次`;
      document.getElementsByClassName("subtitle")[1].innerHTML = `${year}-${month} 中 24 個小時的平均車費`;
    } else {
